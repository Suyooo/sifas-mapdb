...
for F in vendor/*.css; do
    echo "    ${F}"
    purifycss ${F} index.html sppower.html tower.html index.html tower.js notemap/notemap.js notemap/notemap-reader.js js/sppower.js js/story.js js/ui.js js/common.js vendor/materialize.js -m -o build/${F}
done
